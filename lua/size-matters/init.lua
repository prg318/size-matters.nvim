...
if config.default_mappings then
	...
	if vim.fn.has('mac') then
		map("n", "<D-+>", function() M.update_font "grow" end, { desc = "Increase font size" })
		map("n", "<D-=>", function() M.update_font "grow" end, { desc = "Increase font size" })
		map("n", "<D-S-+>", function() M.update_font "grow" end, { desc = "Increase font size" })
		map("n", "<D-->", function() M.update_font "shrink" end, { desc = "Decrease font size" })
		map("n", "<D-ScrollWheelUp>", function() M.update_font "grow" end, { desc = "Increase font size" })
		map("n", "<D-ScrollWheelDown>", function() M.update_font "shrink" end, { desc = "Decrease font size" })
		map("n", "<D-0>", M.reset_font, { desc = "Reset to default font" })
		map("i", "<D-+>", function() M.update_font "grow" end, { desc = "Increase font size" })
		map("i", "<D-=>", function() M.update_font "grow" end, { desc = "Increase font size" })
		map("i", "<D-S-+>", function() M.update_font "grow" end, { desc = "Increase font size" })
		map("i", "<D-->", function() M.update_font "shrink" end, { desc = "Decrease font size" })
		map("i", "<D-ScrollWheelUp>", function() M.update_font "grow" end, { desc = "Increase font size" })
		map("i", "<D-ScrollWheelDown>", function() M.update_font "shrink" end, { desc = "Decrease font size" })
		map("i", "<A-D-=>", M.reset_font, { desc = "Reset to default font" })
	else
